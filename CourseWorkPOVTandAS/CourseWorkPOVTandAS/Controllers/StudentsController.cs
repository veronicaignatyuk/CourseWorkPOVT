...
namespace CourseWorkPOVTandAS.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,Surname,Name,MiddleName,GroupId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Surname,Name,MiddleName,GroupId")] Student student)
        {
            if (ModelState.IsValid)
            {
